...
#ifdef __APPLE__
  string path = "/Transformations/1/";
#else
  string path = "\\Transformations\\1\\";
#endif
  
  ShaderReader shader(Settings.CCExercisesPath(path + "EX_GS_T_1_Vertex.shader").c_str(), Settings.CCExercisesPath(path + "EX_GS_T_1_Fragment.shader").c_str());
