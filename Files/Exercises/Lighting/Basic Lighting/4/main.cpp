...
#ifdef __APPLE__
  string path = "/Basic Lighting/4/";
#else
  string path = "\\Basic Lighting\\4\\";
#endif
  ShaderReader shader(Settings.CCExercisesPath(path + "EX_L_BL_4.vs").c_str(), Settings.CCExercisesPath(path + "EX_L_BL_4.fs").c_str());
  ShaderReader lightShader(Settings.CCExercisesPath(path + "EX_L_BL_4_light.vs").c_str(), Settings.CCExercisesPath(path + "EX_L_BL_4_light.fs").c_str());
